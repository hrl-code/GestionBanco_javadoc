 ...
 * @author rmunoz
 */
public class CuentaAhorro extends javax.swing.JDialog {


    public CuentaAhorro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButtonComprobarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonComprobarActionPerformed
        ...
        if (numCuenta.length()!=20) {
            ...
            JOptionPane.showMessageDialog(null, "Error en el número de cuenta: "
                    + "los dígitos de control no se corresponden con el número tecleado\n"
                        + "Revise el número de cuenta.");
            jTextFieldNumeroCuenta.setForeground(Color.red);
    ...
    private void jButtonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegistrarActionPerformed
        ...
        if (!comprobarCampos()) {
            ...
            if (!comprobarPositivo(saldoIn)) {
                ...
                JOptionPane.showMessageDialog(null, "El Interés debe ser positivo.\nTeclee de nuevo el saldo");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            CuentaAhorro dialog = new CuentaAhorro(new javax.swing.JFrame(), true);
    ...
    Ahorro micuentaAhorro = new Ahorro (numCuenta, nuevoCliente, saldoIn, interesApli);
