 ...
 * @author rmunoz
 */
public class CuentaPersonal extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public CuentaPersonal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButtonComprobarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonComprobarActionPerformed
        ...
        // Comprobamos que el número de cuenta no está ya en uso
            ...
            //En caso de estar todo correcto en el número de cuenta activamos el resto de campos del formulario
            //desactivando el campo numero de cuenta y el botón comprobar
    ...
    private void jButtonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegistrarActionPerformed
        ...
        if (!comprobarCampos()) {
            ...
            if (!comprobarPositivo(saldoIn)) {
                ...
                JOptionPane.showMessageDialog(null, "La comisión de mantenimiento no puede ser 0 negativa.\nTeclee de nuevo la cantidad");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            CuentaPersonal dialog = new CuentaPersonal(new javax.swing.JFrame(), true);
    ...
    Personal micuentaPersonal = new Personal (numCuenta, nuevoCliente, saldoIn, comMantenimiento, cod, maxAutori, misentidades);
