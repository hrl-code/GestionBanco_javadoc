 ...
 * @author rmunoz
 */
public class ListadoCuentas extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ListadoCuentas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoCuentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListadoCuentas dialog = new ListadoCuentas(new javax.swing.JFrame(), true);
