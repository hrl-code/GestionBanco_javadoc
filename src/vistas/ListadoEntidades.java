 ...
 * @author rmunoz
 */
public class ListadoEntidades extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ListadoEntidades(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoEntidades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListadoEntidades dialog = new ListadoEntidades(new javax.swing.JFrame(), true);
